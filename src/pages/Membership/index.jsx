...
import ShowMiniChart from "./mini-charts";
...
export const Membership = () => {
	...
	return (
		<>
			<div className="membership-wrapper flex flex-col w-full h-full p-2 gap-3">
				<div className="topBarUsers flex flex-col justify-center items-start gap-2">
					<span className="pageName">Membership Overview</span>
				...
				<div className="member-grid-view">
					{contentItems.map(({ name, amount }) => (
						<div
							className="content-item bg-zinc-50 flex  w-full capitalize rounded-md hover:bg-slate-50/50"
							key={name}
							onClick={() => {}}>
							<div className="flex flex-row items-start justify-between mr-5">
								<div className="flex flex-col justify-start items-center gap-3 ml-2">
								...
								<div className="max-h-10 mr-5 w-1/3 ">
									<ShowMiniChart />
								</div>
							</div>
						</div>
					...
					<div
						className="content-item bg-zinc-50 flex items-center justify-center px-4 py-2 w-full capitalize rounded-md hover:bg-slate-50/50"
						onClick={() => {}}>
						<Link
							to="/pricing"
